...
<script language="javascript">
		...
		xmlhttp.onreadystatechange = function ( ) {
			if ( xmlhttp.readyState == 4 && xmlhttp.status == 200 ) {
				if ( xmlhttp.responseText == 0 ) {
					...
					document.getElementById("BlackDollar").innerHTML = "<img src='images/red_ok.gif' width='100px' height='100px' style='box-shadow: 10px 10px 5px #888888;' />";//animated gif file if annser if wrongmy
					
					if ( optionNo == 1 ) {
						document.getElementById("options_cell1").style.background = "#F00";
					}
					else if ( optionNo == 2 )
						document.getElementById("options_cell2").style.background = "#F00";
					else if ( optionNo == 3 )
						document.getElementById("options_cell3").style.background = "#F00";
					else if ( optionNo == 4 )
						document.getElementById("options_cell4").style.background = "#F00";
					else if ( optionNo == 5 )
						document.getElementById("options_cell5").style.background = "#F00";
					document.getElementById("dummy").innerHTML= "<embed src=\""+wsoundfile+"\" hidden=\"true\" autostart=\"true\" loop=\"false\" />";
				}
				else {
						document.getElementById("GreenDollar").innerHTML = "<img src='images/green_ok.gif' width='100px' height='100px' style='box-shadow: 10px 10px 5px #888888;'/>";//animated gif fileif answer if right
					if ( optionNo == 1 )//if right display green backgrond in option
						document.getElementById("options_cell1").style.background = "#0F0";
					else if ( optionNo == 2 )
						document.getElementById("options_cell2").style.background = "#0F0";
					else if ( optionNo == 3 )
						document.getElementById("options_cell3").style.background = "#0F0";
					else if ( optionNo == 4 )
						document.getElementById("options_cell4").style.background = "#0F0";
					else if ( optionNo == 5 )
						document.getElementById("options_cell5").style.background = "#0F0";
	...
	function DisplayTime( refrsh ){
		...
		if ( sec == 30 ) { //if time reachers 5sec/q
